    ...
    <table width="960" border="0" cellspacing="0" cellpadding="0">
        <tr align="justify">
            ...
            <td width="760" valign="top">
                ...
                <p>This is free Pharmaceutical Company for your online website, blog or web page which is under Health
                    and Medicine category. Anyone wants good, professional, for their pharmacy, drug store, medical
                    store then this would be the best one. This free pharmaceutical company is designed by professional
                    designers to make your task much easier to customize it.</p><br/>

                <p>There are many other categories like Arts, Agriculture, Computers, Satellite, Cars, Finance, Nature,
                    Music, Personal Website, Religious, Fashion, Furniture, Holiday, Travel, Night club are available in
                    this site. Have a look at the collection of HTML s, pick the right one, preview and download it
                    easily.</p>
            </td>
        </tr>
    </table>
...
<div id="footer">
    <div id="footer_1">
        ...
        <br/>
        <span id="design">Designed by <a id="dum" href="http://www.javatpoint.com"
                                         target="_blank">www.javatpoint.com</a></span>
        <script type="text/javascript">
