...
<table width="960" border="0" cellspacing="10" cellpadding="0" align="center">
    <tr align="justify">
        <td valign="top" width="220px">
            ...
            <h1>Pharmaceutist</h1>
            <p>This is a college project not to be used for personal or professional work without permission from the owner.</p>
    ...
    <table width="960" border="0" cellspacing="0" cellpadding="0">
        <tr align="justify">
            ...
            <td width="760" valign="top">
                ...
                <p>This is free Pharmaceutical Company Template for your online website, blog or web page which is under
                    Health and Medicine category. Anyone wants good, professional, template for their pharmacy, drug
                    store, medical store then this template would be the best one. This free pharmaceutical company
                    template is designed by professional designers to make your task much easier to customize it.</p>
                <br/>

                <p>There are many other template categories like Arts, Agriculture, Computers, Satellite, Cars, Finance,
                    Nature, Music, Personal Website, Religious, Fashion, Furniture, Holiday, Travel, Night club are
                    available in this site. Have a look at the collection of HTML templates, pick the right one, preview
                    and download it easily.</p>
            </td>
        </tr>
    </table>
</div>
...
<div id="footer">
    <div id="footer_1">
        ...
        <br/>
        <span id="design">Designed by Ayush Pathak & Deashish Bera</span>
    </div>
</div>
</body>
</html>
