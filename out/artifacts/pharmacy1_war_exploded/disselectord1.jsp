...
<table><%
      	...
      	try {
			...
			out.print("<tr><th style='color:yellow;'>ID</th><th style='color:yellow;'>PRO CODE</th><th style='color:yellow;'>PRODUCT NAME</th><th style='color:yellow;'>MIN QUAN</th><th style='color:yellow;'>ORDER QUEUE</th><th style='color:yellow;'>NET COST</th><th style='color:yellow;'>AMOUNT</th></tr>");
			//while(rs.next()){
			if(rs.next()){
							
				out.print("<tr>");
				out.print("<font color='yellow'>This order has been selected</font>");
				
				out.print("<td style='color:yellow;'>" + rs.getString(1) + "</td>");
				out.print("<td style='color:yellow;'>" + rs.getString(2) + "</td>");
				out.print("<td style='color:yellow;'>" + rs.getString(3) + "</td>");
				out.print("<td style='color:yellow;'>" + rs.getString(5) + "</td>");
				out.print("<td style='color:yellow;'>" + rs.getString(6) + "</td>");
				//out.print("<td>" + rs.getString(7) + "</td>");
				out.print("<td style='color:yellow;'>" + rs.getString(8) + "</td>");
				out.print("<td style='color:yellow;'>" + rs.getString(9) + "</td>");
	        ...
	        out.print("<p style=\"color:red; font-size:20px;\">Your given ID is wrong.</p>");
