...
<table style="background-color:#1fc8e0;" align="center"><%
      	...
      	try {
			...
			out.print("<td><a href='Deleteorders.jsp' style='color:red;'>Delete</a></td>");
			out.print("<td><a href='Updateorders.jsp' style='color:yellow;'>Update</a></td>");
			
			out.print("<tr><th>ID</th><th>PRO CODE</th><th>PRODUCT NAME</th><th>MIN QUANTITY</th><th>ORDER QUEUE</th><th>NET COST</th><th>AMOUNT</th></tr>");
			while(rs.next()){
				//int id=rs.getInt(1);
