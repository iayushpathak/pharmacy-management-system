...
<table width="300" border="0" cellspacing="10" cellpadding="0" align="center"><%
		...
		try {
		if(status==true){
			out.print("<p style=\"color:red; font-size:20px;\">Welcome to the pharmacy order portal click on the link below to see the orders.</p>");
		
			out.println("<br><br><a href='distributerorder.jsp' style='color:yellow;'>Click to see orders.</a> " );
...
<%@ page import="static java.awt.Color.yellow" %>
