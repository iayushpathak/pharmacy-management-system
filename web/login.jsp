    ...
    <tr align="center">
        <td valign="top">
            ...
            <table width="300" border="0" cellspacing="10" cellpadding="0" align="center"><%
                ...
                try {
                    if (status == true) {
                        out.print("<h2 style='color:#b012b5;'>Welcome... Please click on the below link to place your order</h2>   ");

                        out.println("<br><a href='order.jsp' style='color:yellow;'>Click to place an order</a> ");
